...
class Filter(object):
    def __init__(self, **terms):
        """ Terms is a dictionary representing a disjunction (or) of conditions.
        """
        self.terms = []
    ...
    def notequals(self, field, value):
        return type(value)(field) != value
    ...
    def inrange(self, field, value):
        lo, hi = value
        t = type(lo)
        assert t is type(hi)
        return lo <= t(field) < hi

    def notinrange(self, field, value):
        return not self.inrange(field, value)

    # comparators for string types

    def iequals(self, field, value):
        return field.lower() == value

    def notiequals(self, field, value):
        return field.lower() != value

    def contains(self, field, value):
        return value in field

    def notcontains(self, field, value):
        return value not in field

    def icontains(self, field, value):
        return value in field.lower()

    def noticontains(self, field, value):
        return value not in field.lower()

    def startswith(self, field, value):
        return field.startswith(value)

    def notstartswith(self, field, value):
        return not field.startswith(value)

    def istartswith(self, field, value):
        return field.lower().startswith(value)

    def notistartswith(self, field, value):
        return not field.lower().startswith(value)

    def endswith(self, field, value):
        return field.endswith(value)

    def notendswith(self, field, value):
        return not field.endswith(value)

    def iendswith(self, field, value):
        return field.lower().endswith(value)

    def notiendswith(self, field, value):
        return not field.lower().endswith(value)

    def regexp(self, field, value):
        return value(field)

    def __call__(self, field):
        return any(op(self, field, value) for op, value in self.terms)
...
class RecordFilter(object):
    """
    Implements SQL like 'where' features for search into containers
    """
